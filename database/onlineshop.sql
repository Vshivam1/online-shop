...
(1, 12, 'Shivam', 'varmashivam855@gmail.com', 'Bangalore, Kumbalagodu, Karnataka', 'Bangalore', 'Karnataka', 560074, 'pokjhgfcxc', '4321 2345 6788 7654', '12/90', 3, 77000, 1234);
...
(2, 1, 3, 'iPhone 5s', 25000, 'iphone 5s', 'http___pluspng.com_img-png_iphone-hd-png-iphone-apple-png-file-550.png', 'iphone'),
(3, 1, 3, 'iPad air 2', 30000, 'ipad apple brand', 'da4371ffa192a115f922b1c0dff88193.png', 'ipad,tablet'),
(4, 1, 3, 'iPhone 6s', 32000, 'Apple iPhone ', 'http___pluspng.com_img-png_iphone-6s-png-iphone-6s-gold-64gb-1000.png','iphone'),
(5, 1, 2, 'iPad 2', 10000, 'samsung ipad', 'iPad-air.png', 'ipad tablet samsung'),
(6, 1, 1, 'samsung Laptop r series', 35000, 'samsung Black combination Laptop', 'laptop_PNG5939.png', 'laptop '),
...
(10, 2, 6, 'Red Ladies dress', 1000, 'red dress for girls', 'red dress.jpg', 'dress '),
...
(12, 'Shivam', 'varma', 'varmashivam855@gmail.com', 'Shivam', '7275588097', '123456789', 'sdcjns,djc'),
(14, 'newuser', 'user', 'newuser@gmail.com', 'Shivam@123', '9535688928', 'Bangalore', 'Kumbalagodu'),
(15, 'otheruser', 'user', 'otheruser@gmail.com', 'shivam@123', '9535688928', 'Bangalore', 'Kumbalagodu');
...
ALTER TABLE `orders_info` DROP FOREIGN KEY `user_id`;

-- Now add it back with ON DELETE CASCADE
ALTER TABLE `orders_info`
  ADD CONSTRAINT `user_id` DROP FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`) ON DELETE CASCADE;
