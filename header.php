...
<div class="col-md-6">
    ...
    <input type="text" id="search-box" placeholder="Search for products..." autocomplete="off">
...
<!-- / BAR -->
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								<!-- Wishlist -->
								<div>
									<a href="https://github.com/Vshivam1">
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown"  >
										...
										<div class="cart-btns">
												<a href="cart.php" style="width:100%;"><i class="fa fa-edit"></i> Show cart</a>
